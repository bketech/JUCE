/*
    filename - This file is part of Element
    Copyright (C) 2013  Michael Fisher <mfisher31@gmail.com>

    This is an infiltration of juce audio so that it can better handle
    plugins that are port basede (e.g. LV2)
...
#ifndef JUCE_PORTTYPE_H_INCLUDED
#define JUCE_PORTTYPE_H_INCLUDED

#ifndef JUCE_INVALID_PORT
#define JUCE_INVALID_PORT (uint32)-1
#endif
...
#endif   // JUCE_PORTTYPE_H_INCLUDED
